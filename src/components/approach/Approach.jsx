                ...
                <div className="approach-details">
                    <div className="box">
                        ...
                        <p className="desc">
                            ...
                            with card networks and banks to checkout flows in
                            the browser, we operate on and optimize at every
                    ...
                    <div className="box">
                        ...
                        <p className="desc">
                            We release{' '}
                            <a href="#features">hundreds of features</a> and
                            improvements each year to help you stay ahead of
                    ...
                    <div className="box">
                        ...
                        <p className="desc">
                            ...
                            <a href="#uptime">99.99%+</a> uptime and are highly
                            scalable and redundant. Stripe is certified to the
                    ...
                    <div className="box">
                        ...
                        <p className="desc">
                            ...
                            <a href="#billions">billions</a> of data points and
                            help increase revenue across conversion, fraud,
